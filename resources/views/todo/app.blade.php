    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card mb-3">
          <div class="card-body">
            <!-- 02. Form input data -->
            {{-- lakukan post beserta data form ke url "/todo" --}}
            <form id="todo-form" action="{{ url('/todo')}}" method="post"> 
              {{-- csrf berfungsi untuk menambahkan data token (hidden inputs) --}}
              @csrf
            ...
            <ul class="list-group mb-4" id="todo-list">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                  ...
                  <button class="btn btn-primary btn-sm edit-btn" data-bs-toggle="collapse" data-bs-target="#collapse-1"
